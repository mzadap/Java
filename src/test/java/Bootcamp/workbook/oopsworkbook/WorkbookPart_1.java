...
public class WorkbookPart_1 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i<person.length; i++) {
            airline.setPerson(person[i]);

        }
  /*     Person ten = airline.getPerson(10);
        ten.setSeatNumber(10);*/
        //System.out.println(ten.getSeatNumber());

       for (int i = 0; i < person.length; i++) {
           airline.createReservation(person[i]);
       }
